    ...
    "logs_collected": {
      "files": {
        "collect_list": [
          ...
          {
            "file_path": "/var/log/k2hb/k2hb**.log",
            "log_group_name": "${cwa_log_group_name}",
            "log_stream_name": "{instance_id}-k2hb.log",
            "timezone": "UTC"
          },
          {
          ...
          {
            "file_path": "/var/log/k2hb/respawn_k2hb.log",
            "log_group_name": "${cwa_log_group_name}",
            "log_stream_name": "{instance_id}-respawn_k2hb.log",
            "timezone": "UTC"
          },
          {
