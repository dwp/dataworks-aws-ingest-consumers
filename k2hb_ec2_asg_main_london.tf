...
resource "aws_launch_template" "k2hb_main_london" {
  ...
  user_data = base64encode(templatefile("k2hb_userdata.tpl", {
    ...
    k2hb_hbase_bypass                                = local.k2hb_main_hbase_bypass[local.environment]
  ...
  block_device_mappings {
    ...
    ebs {
      volume_size           = local.k2hb_main_ebs_size[local.environment]
      volume_type           = local.k2hb_main_ebs_type[local.environment]
